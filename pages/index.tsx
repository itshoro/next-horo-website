...
export default function Home({ timeline_areas }: { timeline_areas: any }) {
  const toolItems = (
  ...
  return (
    <>
      ...
      <Section className="!px-0">
        <div className="w-full divide-y divide-accent rounded-lg lg:rounded-none lg:max-w-[720px] mx-auto">
          <Timeline areas={timeline_areas} />
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const fileContents = await fs.readFile(entriesPath, "utf8");
  const timeline_entries = JSON.parse(fileContents);

  return {
    props: {
      timeline_areas: timeline_entries.data,
    },
  };
};
